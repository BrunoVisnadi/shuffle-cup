...
urlpatterns = [
    ...
    path("manage/room/<int:room_id>/result/", views.edit_room_result, name="edit_room_result"),
    path("manage/standings/", views.admin_standings, name="admin_standings"),
    path("manage/results/", views.admin_round_results, name="admin_round_results"),
